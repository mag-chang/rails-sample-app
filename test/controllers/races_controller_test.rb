...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { area: @race.area, name: @race.name, review: @race.review, started_on: @race.started_on } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { area: @race.area, name: @race.name, review: @race.review, started_on: @race.started_on } }
